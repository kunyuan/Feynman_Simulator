...
class Array1 : public array1<T> {
  ...
  public:
    ...
    void Dimension(const Array1<T> &A)
    {
        ...
        this->state = A.test(this->temporary);
    }
    ...
    T &operator[](int ix) const
    {
        __check(ix, this->size, ox, 1, 1);
        return voff[ix];
    }
    T &operator()(int i) const
    {
        __check(i, this->size, 0, 1, 1);
        return this->v[i];
    }
    T *operator()() const
    {
    ...
    Array1<T> operator+(int i) const
    {
        return Array1<T>(this->size - i, this->v + i, ox);
    }
    void Set(T *a)
    {
        this->v = a;
...
class Array4 : public array4<T> {
  ...
  public:
                   ...
                   int ox0 = 0, int oy0 = 0, int oz0 = 0, int ow0 = 0)
    {
        ...
        this->nz = nz0;
        this->nw = nw0;
        this->nzw = this->nz * this->nw;
        this->nyzw = this->ny * this->nzw;
...
class Array5 : public array5<T> {
  ...
  public:
                   ...
                   int ox0 = 0, int oy0 = 0, int oz0 = 0, int ow0 = 0, int ov0 = 0)
    {
        ...
        this->nw = nw0;
        this->nv = nv0;
        this->nwv = this->nw * this->nv;
        this->nzwv = this->nz * this->nwv;
    ...
    T &operator()(int ix, int iy, int iz, int iw, int iv) const
    {
        ...
        return voff[ix * (int)this->nyzwv + iy * (int)this->nzwv + iz * (int)this->nwv + iw * (int)this->nv + iv];
    }
    T &operator()(int i) const
    {
