...
void GLine::SetGLine(Momentum k, const Complex &weight, bool ismeasure, bool isgammaG=false)
{
    K = k;
    Weight = weight;
    IsMeasure = ismeasure;
...
void WLine::SetWLine(Momentum k, const Complex &weight, bool isworm, bool ismeasure, bool isdelta, bool isgammaW=false)
{
    K = k;
    Weight = weight;
    IsWorm = isworm;
